...
@WebServlet("/selectBoard.ad")
public class SelectBoardAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public SelectBoardAdminServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//게시글 전체 출력
				ArrayList<Board> list = new AdminService().selectBoard(currentPage, limit);
