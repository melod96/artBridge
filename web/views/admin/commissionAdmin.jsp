...
<body>
    <div id="all">
		...
		<section class="tit-area bg-yellow"><!-- 컬러변경시 bg-컬러명(gray,green,blue,yellow) 으로 바꿔주세요 -->
            <div class="container">
                ...
                <ul class="tab-menu">
                    ...
                    <li><a href="#" style="background:orangered; color:white;" id="commissionBtn">커미션 관리</a></li>
        ...
        <div class="contents"><!-- contents 필수 사용 -->
            <div class="container"><!-- container 필수 사용 -->
                <div class="col-md-12">
                    ...
                    <button name="mainBtn" class="btn btn-primary btn-sm" onclick="add();">검색어 추가</button>
					<button name="mainBtn" class="btn btn-primary btn-sm" onclick="del();">검색어 삭제</button>
                        ...
                        <colgroup>
                         ...
                         <thead>
                            <tr>
                                <th scope="col">선택</th>
                                <th scope="col">번호</th>
                                <th scope="col" td="" colspan="3">검색어</th>
                    ...
                    function add() {
							...
							$(function() {
								...
								$(		"<tr><td><input type="+"checkbox "+"name="+"chBox"+"></td>"
										+"<td class="+"num"+">"+i+"</td><td class="+"addsh"+">"+addsc+"</td></tr>").appendTo(
										$(".addsh2"));
		...
		<button type="submit" id="addBtn" name="mainBtn" class="btn btn-primary btn-md" style="padding:10px 22px;" >저장</button>
                ...
                <div class="col-md-12">
                    ...
                    <table class="tbl-type02">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="background:lightgray;">검색옵션
                                </td>
                                <td>                
                                	<select name = "national2" style="float:left; width:200px;">
                            ...
                            <tr>
                                ...
                                <td>
                                	...
                                	<button type="submit" id="searchBtn" name="searchBtn" class="btn btn-primary btn-sm" style="padding:5px 22px; float:right;" >검색</button>
                                </td>
                            </tr>
                     ...
                     <br>
                      ...
                      <button type="submit" id="deleteBtn" name="deleteBtn" class="btn btn-primary btn-sm" style="padding:5px 22px; float:right;" onclick="del2();">게시글 삭제</button><br>
                     <br> 
                      <script>
                    ...
                    <table class="tbl-type02">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><input type="checkbox" name="chBox2">
                                </td>
                                <td class="num2">                
                                	1
                                </td>
