...
<head>
	...
	<style type="text/css">
        ...
        .txt01 li{padding-left:15px; background:url(../image/common/btn_next.png) 0 4px no-repeat; background-size:5px; color:#3446d1; font-weight:bold; margin-bottom:5px; font-size:14px;}
